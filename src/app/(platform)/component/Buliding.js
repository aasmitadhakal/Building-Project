...
function Buliding() {
    ...
    return (
        ...
        <div className="bg-gray py-8">
          ...
          <p className='text-blue md:text-[36px] text-[26px] leading-[49px] md:font-[700] font-[700] my-1 grid place-content-center '>Our Building Process</p>
            </div>
            <div className="container mx-auto px-4">
                {data.map((item, index) => (
                    <div key={index} className={`flex flex-wrap items-center mb-8 ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                        <div className="w-full md:w-1/2 mb-4 md:mb-0">
                            <h2 className="my-1 text-black font-[600] text-[24px] leading-[32px] mx-4">{item.title}</h2>
