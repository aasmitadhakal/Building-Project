            ...
            <div className="shadow-xl p-4">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="text-cutombrown text-[18px] pl-4  leading-[24px] font-[400]">First Floor</p>
                </div>
                <div>
                  <img src={axiosInstance.defaults.baseURL + property.other_image} alt={property.title} className="h-[177px] w-[418px] mb-4" />
                  <p className="text-cutombrown text-[18px] pl-4  leading-[24px] font-[400]">Ground Floor</p>
                </div>
                <div className="md:my-4  font-[Montserrat]">
