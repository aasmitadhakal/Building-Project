...
const Login = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-sm mx-auto mt-20 border font-[karla]  p-10 rounded-md">
        <div className="h-44 flex justify-center  "><img src={img} className="h-44"></img></div>
      <div className="mb-5">
