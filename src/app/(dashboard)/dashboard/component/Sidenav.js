      ...
      >
        <div className={`relative h-full overflow-auto`}>
          <div className=" bg-white z-50 mb-4">
            <Link
              href="/"
              className="flex items-center shadow-none justify-center my-1"
            >
          ...
          <div className=" mt-4 ">
            <ul className="mb-4 flex flex-col gap-2 px-4">
              <h3 className="py-2 tracking-[.1rem] font-normal uppercase text-xs text-sidebar-foreground">
                Dashboard
              </h3>
              <li>
                <Link href="/dashboard">
                ...
                >
                  <ListItem className="p-0" selected={open === 2}>
                    <AccordionHeader
                      ...
                      className="border-none shadow-none py-0 px-4"
                    >
              ...
              <li>
                <Link href="/dashboard/whychooseus">
                  <span
                    className={`${
                      pathname === "/dashboard/whychooseus"
                        ? "bg-blue-100 text-black"
                        : "text-black"
                    } flex items-center uppercase rounded-md px-4 py-2 text-sm font-normal hover:bg-accent hover:text-accent-foreground`}
                  >
              ...
              <li>
                <Link href="/dashboard/clientjourney">
                  <span
                    className={`${
                      pathname === "/dashboard/clientjourney"
                        ? "bg-blue-100 text-black"
                        : "text-black"
                    } flex items-center uppercase rounded-md px-4 py-2 text-sm font-normal hover:bg-accent hover:text-accent-foreground`}
                  >
