...
const CreatePartner = () => {
  ...
  return (
    <div className="shadow-lg p-5 rounded-md w-full mt-20   bg-white">
      <div>
        <p className="text-2xl font-bold mb-4">Add New Partner</p>
        <form onSubmit={handleSubmit}>
          ...
          <Link href="/dashboard/partneruniversity" className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mt-5">
            Cancel
          </Link>
        </form>
      </div>
