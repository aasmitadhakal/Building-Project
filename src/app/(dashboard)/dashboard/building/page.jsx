...
const Page = () => {
  ...
  const handleDelete = async (id) => {
    try {
      await axiosInstance.delete(`/api/journey/${id}`);
  ...
  const columns = ["SN", "order", "image", "title","sub_Description", "Actions"];
      ...
      <section className="p-5 w-full px-10 bg-white rounded-sm mt-20">
        <div className="max-w-screen-lg w-full">
          <div className="flex justify-between mb-4">
            <h3 className="text-2xl font-bold">Building Process</h3>
